...
- **Multi-format support**: Compare JSON, JSONL, YAML, CSV, and TSV with format selectors on each side
...
1. Select the format for each side (JSON, JSONL, YAML, CSV, or TSV) using the format selector, then paste or drag your data into the editors

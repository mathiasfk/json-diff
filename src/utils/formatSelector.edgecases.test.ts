...
describe('formatSelector edge cases', () => {
  ...
  describe('special characters', () => {
    it('preserves emoji in JSON string values', () => {
      expect(parse('{"a":"🎉"}', 'json')).toEqual({ a: '🎉' });
    });
  ...
  describe('scalar & array-of-primitives serialization', () => {
    ...
    it('serializes an array of primitives as JSONL lines', () => {
  ...
  describe('error reporting', () => {
    ...
    it('exposes FormatError as a class with the expected name', () => {
      const err = new FormatError('boom', 'json', 3);
